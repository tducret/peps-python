...
_GITHUB_URL = 'https://github.com/tducret/peps-python'
_KEYWORDS = ['api', 'peps', 'parsing',
...
setup(
    ...
    description="Python wrapper for peps.cnes.fr",
    long_description="Python wrapper for peps.cnes.fr",
